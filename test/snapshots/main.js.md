...
> Snapshot 1
    ...
    .min-w-screen-safe {␊
        min-height: calc(100vh - (env(safe-area-inset-left) + env(safe-area-inset-right)));␊
        min-height: -webkit-fill-available␊
    }␊
    .max-w-screen-safe {␊
        max-height: calc(100vh - (env(safe-area-inset-left) + env(safe-area-inset-right)));␊
        max-height: -webkit-fill-available␊
    }␊
    .w-screen-safe {␊
    ...
    .-max-w-screen-safe-offset-1 {␊
        max-height: calc(calc(100vh - (env(safe-area-inset-left) + env(safe-area-inset-right))) + -8px);␊
        max-height: -webkit-fill-available␊
    }␊
    .-mb-safe-offset-1 {␊
        margin-bottom: calc(env(safe-area-inset-bottom) + -8px)␊
    ...
    .-min-w-screen-safe-offset-1 {␊
        min-height: calc(calc(100vh - (env(safe-area-inset-left) + env(safe-area-inset-right))) + -8px);␊
        min-height: -webkit-fill-available␊
    }␊
    .-ml-safe-offset-1 {␊
        margin-left: calc(env(safe-area-inset-left) + -8px)␊
    ...
    .-w-screen-safe-offset-1 {␊
        height: calc(calc(100vh - (env(safe-area-inset-left) + env(safe-area-inset-right))) + -8px);␊
        height: -webkit-fill-available␊
    }␊
    .bottom-safe-offset-1 {␊
        bottom: calc(env(safe-area-inset-bottom) + 8px)␊
    ...
    .-max-w-screen-safe-min-1 {␊
        max-height: min(calc(100vh - (env(safe-area-inset-left) + env(safe-area-inset-right))), -8px);␊
        max-height: -webkit-fill-available␊
    }␊
    .-mb-safe-min-1 {␊
        margin-bottom: min(env(safe-area-inset-bottom), -8px)␊
    ...
    .-min-w-screen-safe-min-1 {␊
        min-height: min(calc(100vh - (env(safe-area-inset-left) + env(safe-area-inset-right))), -8px);␊
        min-height: -webkit-fill-available␊
    }␊
    .-ml-safe-min-1 {␊
        margin-left: min(env(safe-area-inset-left), -8px)␊
    ...
    .-w-screen-safe-min-1 {␊
        height: min(calc(100vh - (env(safe-area-inset-left) + env(safe-area-inset-right))), -8px);␊
        height: -webkit-fill-available␊
    }␊
    .bottom-safe-min-1 {␊
        bottom: min(env(safe-area-inset-bottom), 8px)␊
    ...
    .-max-w-screen-safe-max-1 {␊
        max-height: max(calc(100vh - (env(safe-area-inset-left) + env(safe-area-inset-right))), -8px);␊
        max-height: -webkit-fill-available␊
    }␊
    .-mb-safe-max-1 {␊
        margin-bottom: max(env(safe-area-inset-bottom), -8px)␊
    ...
    .-min-w-screen-safe-max-1 {␊
        min-height: max(calc(100vh - (env(safe-area-inset-left) + env(safe-area-inset-right))), -8px);␊
        min-height: -webkit-fill-available␊
    }␊
    .-ml-safe-max-1 {␊
        margin-left: max(env(safe-area-inset-left), -8px)␊
    ...
    .-w-screen-safe-max-1 {␊
        height: max(calc(100vh - (env(safe-area-inset-left) + env(safe-area-inset-right))), -8px);␊
        height: -webkit-fill-available␊
    }␊
    .bottom-safe-max-1 {␊
        bottom: max(env(safe-area-inset-bottom), 8px)␊
